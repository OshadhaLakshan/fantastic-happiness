...
def main():
    ...
    # Output the file's media type
    print(media_type)


def get_media_type(file_name):
    # Define media types for known file extensions
    media_types = {
        ".aac": "audio/aac",
    ...
    # Check the file extension against known media types
    for extension, media in media_types.items():
        if file_name.endswith(extension):
            return media

    # Default media type if extension is not recognized
